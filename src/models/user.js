...
UserSchema.pre(["save", "updateOne"], function (next) {
  ...
  if (isEmailValidated) {
    if (data?.password) {
      ...
      console.log("Password validation result:", isPasswordValidated); // Debugging line

      if (isPasswordValidated) {
        this.password = data.password = passwordEncrypt(data.password);
        this._update = data; // updateOne will wait data from "this._update".
        console.log(
          "Password encrypted and data updated:",
          this.password,
          this._update
        ); // Debugging line
      } else {
        console.log("Password validation failed for:", data.password); // Debugging line
